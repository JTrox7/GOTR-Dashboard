...
# Custom style: dark background, white text, green sidebar section
st.markdown("""
    <style>
    ...
    .stSidebar .stMarkdown, .stSidebar .css-1d391kg {
        color: white !important;
    }

    /* Preserve white input boxes elsewhere */
