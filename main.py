...
# Sidebar: Show list of variables
...
# Custom page configuration and background styling
...
# Expander for variable meanings
with st.expander("🧠 What do the variable names mean?"):
    ...
    - **MAKEFUN** — I have classmates who make fun of me  
